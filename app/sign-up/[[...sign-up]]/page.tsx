      ...
      <div className="hidden lg:flex w-1/2 flex-col justify-center px-20 bg-gradient-to-br from-[#ffdde1] to-[#ee9ca7] relative overflow-hidden">
        <div className="absolute inset-x-0 bottom-0 pointer-events-none opacity-50 translate-y-2">
          <svg className="w-full h-auto min-h-[300px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 24 150 28" preserveAspectRatio="none" shapeRendering="auto">
            <defs><path id="gwave2" d="M-160 44c30 0 58-18 88-18s 58 18 88 18 58-18 88-18 58 18 88 18 v44h-352z" /></defs>
            <g className="animate-[wave_10s_linear_infinite]"><use href="#gwave2" x="48" y="0" fill="rgba(255,255,255,0.7)" /></g>
            <g className="animate-[wave_14s_linear_infinite_reverse]"><use href="#gwave2" x="48" y="3" fill="rgba(255,255,255,0.5)" /></g>
            <g className="animate-[wave_20s_linear_infinite]"><use href="#gwave2" x="48" y="5" fill="rgba(255,255,255,0.3)" /></g>
            <g className="animate-[wave_12s_linear_infinite_reverse]"><use href="#gwave2" x="48" y="7" fill="#ffffff" /></g>
          </svg>
        </div>
        ...
        <div className="z-10 text-white drop-shadow-md">
          ...
          <p className="text-white/90 max-w-sm mt-8 leading-relaxed font-medium">
            สร้างบัญชีเพื่อจองบ้านพักพูลวิลล่า ง่าย สะดวก ปลอดภัย
          </p>
        </div>
      </div>
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center px-4 sm:px-8 bg-white min-h-screen">
        <SignUp
          appearance={{
            elements: {
